...
`
	Eslint = `// https://docs.expo.dev/guides/using-eslint/
 ...
 * Icon name are based on SF Symbols and require manual mapping to Material Icons.
 */
export function IconSymbol({
  name,
  size = 24,
    ...
    console.log(
      '1. Run "npx expo start" to start a development server.\n2. Edit app/index.tsx to edit the main screen.' +
        (userInput === "y"
          ? "\n3. Delete the /" +
            exampleDir +
            " directory when you're done referencing it."
          : "")
    );
  } catch (error) {
