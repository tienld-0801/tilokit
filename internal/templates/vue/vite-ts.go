...
app.mount('#app')`
	...
	ViteTsAppFile = `<script setup lang="ts">
...
@media (min-width: 1024px) {
  ...
  nav {
	...
	ViteTSHelloWordVue = `<script setup lang="ts">
defineProps<{
  msg: string
}>()
</script>
...
<html lang="en">
  ...
  <body>
	...
	ViteTsRouter = `import { createRouter, createWebHistory } from 'vue-router'
...
export default router`
	...
	ViteTsHomeView = `<script setup lang="ts">
...
@media (min-width: 1024px) {
  .about {
	...
	ViteTsTheWelcome = `<script setup lang="ts">
...
@media (min-width: 1024px) {
  ...
  #app {
	...
	ViteTsBaseCss = `/* CSS Reset and Base Styles */
*,
*::before,
*::after {
