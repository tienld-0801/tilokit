...
<html lang="en">
  ...
  <body>
	...
	ViteJsRouter = `import { createRouter, createWebHistory } from 'vue-router'
...
export default router`
	...
	ViteJsHomeView = `<script setup lang="js">
...
@media (min-width: 1024px) {
  .about {
	...
	ViteJsTheWelcome = `<script setup lang="js">
...
@media (min-width: 1024px) {
  ...
  #app {
	...
	ViteJsBaseCss = `/* CSS Reset and Base Styles */
*,
*::before,
*::after {
